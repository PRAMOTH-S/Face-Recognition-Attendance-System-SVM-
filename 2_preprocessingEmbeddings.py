...
#prototxt = r"D:\AI\DAY 18\model\deploy.prototxt"
#model = r"D:\AI\DAY 18\model\res10_300x300_ssd_iter_140000.caffemodel"

BASE_DIR = os.path.dirname(os.path.abspath(__file__))

prototxt = os.path.join(BASE_DIR, "model", "deploy.prototxt")
model = os.path.join(BASE_DIR, "model", "res10_300x300_ssd_iter_140000.caffemodel")
embeddingModel = os.path.join(BASE_DIR, "openface_nn4.small2.v1.t7")
